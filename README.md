...
![Dataflow Block Diagram](Documetation/Images/DataflowBlockDiagram.png)
...
However, as of April 2026, I could not find any up-to-date documentation on how to build and program one yourself.
